...
<div class="background-image-container" style="background-image: url('{{ asset('img/pexels-lili.jpg') }}');">
        ...
        <div class="left-white-box">
           <h2> Avant l'accouchement :</h2>
            <p> Préparez votre corps et votre esprit. <br> 
...
<div class="background-image-container" style="background-image: url('{{ asset('img/women-practicing-together.jpg') }}');">
    <div class="long-white-box">
        <h2>Aprés l'accouchement :</h2> 
        <p> Nous comprenons les besoins spécifiques des futures mamans. <br>
            <br> Notre salle de sport est spécialement conçue pour accompagner les femmes enceintes dans chaque étape de leur parcours, avant et après l'accouchement. <br> 
            <br> Nos cours et programmes sont pensés pour vous aider à rester en forme, à améliorer votre bien-être mental et physique, et à vous préparer en douceur pour le jour de l'accouchement.</p><br>
    </div>
</div>
